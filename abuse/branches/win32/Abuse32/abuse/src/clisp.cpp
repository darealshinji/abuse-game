...
// to interface with c
{
    ...
    // js duped...?  l_fire_object=make_find_symbol("fire_object");
    ...
    add_c_function("scroll_message", 1, 2,     1005);  // scroll_message
    ...
    add_lisp_function("user_fun",0,-1,            16);   // calls an object's user function
...
void *l_caller(long number, void *args)
{
    ...
    switch (number) {
    case 0: {
            current_object->set_aistate((unsigned char) lnumber_value(eval(CAR(args)))); 
    ...
    case 4 : {
            if (player_list->next)
                ...
                return new_lisp_pointer(player_list->focus);
        }
        break;
...
long c_caller(long number, void *args)
{
    ...
    case 17 : current_object->set_fade_dir((signed char) lnumber_value(CAR(args))); return 1; break;
    case 18 : 
        { 
    ...
    case 19 : current_object->set_fade_count((unsigned char) lnumber_value(CAR(args))); return 1; break;
    ...
    case 57 : current_object->direction = (signed char) lnumber_value(CAR(args)); break;
    case 58 : 
        {
    ...
    case 92 : 
        {
            ...
            screen->line((short) cx1, (short) cy1, (short) cx2, (short) cy2, (unsigned char) c);
            return 1;
        } break;
    ...
    case 119 : current_object->set_fx((unsigned char) lnumber_value(CAR(args))); break;
    case 120 : current_object->set_fy((unsigned char) lnumber_value(CAR(args))); break;
    case 121 : current_object->set_fxvel((unsigned char) lnumber_value(CAR(args))); break;
    case 122 : current_object->set_fyvel((unsigned char) lnumber_value(CAR(args))); break;
    case 123 : current_object->set_fxacel((unsigned char) lnumber_value(CAR(args))); break;
    case 124 : current_object->set_fyacel((unsigned char) lnumber_value(CAR(args))); break;
    ...
    case 192 : 
        {     
            ...
            if (x<0 || y<0 || x>=current_level->foreground_width() || y>=current_level->foreground_width())
                ...
                current_level->put_fg(x, y, (unsigned short) type);
        } break;
    case 193 :
        { 
            long x=lnumber_value(CAR(args)); args=CDR(args);
    ...
    case 194 : 
        {     
            ...
            if (x < 0 || y < 0 || x >= current_level->background_width() || y >= current_level->background_width())
                ...
                current_level->put_bg( x, y, (unsigned short) type);
        } break;
    case 195 :
        { 
            long x=lnumber_value(CAR(args)); args=CDR(args);
    ...
    case 199 :
        {
            current_start_type = (short) lnumber_value(CAR(args));
            set_local_players(1);
        } break;
    case 200 :
        {
    ...
    case 206 :
        {
            ...
            if (x < current_object->total_frames())
                current_object->current_frame = (short) x;
            else      
    ...
    case 216 :
        {
            ...
            cash.img(id)->put_image(screen, (short) x1, (short) y1, 1);
        } break;
    case 217 :
        {
            view *v=current_object->controller();
    ...
    case 224 :
        {
            current_object->set_hp((unsigned short) lnumber_value(CAR(args)));   
        } break;
    case 225 :
        {
            char *fn=lstring_value(CAR(args));
    ...
    case 232 :
        {
            ambient_ramp += (short) lnumber_value(CAR(args));
        } break;
    ...
    case 237 : {
            rand_on += (unsigned short) lnumber_value(CAR(args));
            return 1;
        } break;
    case 238 : {
    ...
    case 247 :
        {
            ...
            long c1 = lnumber_value(CAR(args)); args=lcdr(args);      
            screen->bar((short) cx1, (short) cy1, (short) cx2, (short) cy2, (unsigned char) c1);
        } break;
    case 248 :
        {
            return start_argc;
    ...
    case 259 : {
            ...
            if (!v) {
                lprint(args);
                printf("set_tkills : object has no view!\n");
            }
            else
    ...
    case 282 :
        {
            ...
            long y2 = lnumber_value(CAR(args));   args=CDR(args);
            long c = lnumber_value(CAR(args));
            screen->bar((short) x1, (short) y1, (short) x2, (short) y2, (unsigned char) c);
        } break;
    case 283 :
        {
            long x1 = lnumber_value(CAR(args));   args = CDR(args);
            ...
            long y2 = lnumber_value(CAR(args));   args = CDR(args);
            long c = lnumber_value(CAR(args));
            screen->rectangle((short) x1, (short) y1, (short) x2, (short) y2, (unsigned char) c);
        } break;
    case 284 :
        {
    ...
    case 296 : {
            if (main_net_cfg)
                main_net_cfg->min_players = (char) lnumber_value(CAR(args));
        } break;
    case 1001: { // (set_object_tint)
            if (current_object->Controller)
                current_object->Controller->SetTint(lnumber_value(CAR(args)));
            else
                current_object->SetTint(lnumber_value(CAR(args)));
        } break;
    case 1002: { // (get_object_tint)
            if (current_object->Controller)
                return current_object->Controller->GetTint();
            else
                return current_object->GetTint();
        } break;
    case 1003: { // (set_object_team)
            if (current_object->Controller)
                current_object->Controller->SetTeam(lnumber_value(CAR(args)));
            else
                current_object->SetTeam(lnumber_value(CAR(args)));
        } break;
    case 1004: { // (get_object_team)
            if (current_object->Controller)
                return current_object->Controller->GetTeam();
            else
                return current_object->GetTeam();
        } break;
    case 1005: { // scroll_message
            image *img = NULL;
            char *text = NULL;
            text = lstring_value(CAR(args)); args=CDR(args);
            if (args)
                img = cash.img(lnumber_value(CAR(args)));
            ScrollMessage(text, img);
        }
        break;
    default:
        dprintf("l_caller -- Undefined c function %d\n", number);
        return 0;
  }
  return 0;
}
