...
b
	 (defun get_train_msg (message_num)
	   (select message_num
		   ...
		   (0 "Aim gun with mouse, fire with mouse button")
		   ...
		   (5 "You can now use the special key to use your special powers")
		   (6 "You can now select weapons with the selection keys")
	 ...
	 (setq lev_complete    "Level %d Completed!")
	 ...
	 (setq missing_c       "This level is missing copyright information, cannot load\n")
