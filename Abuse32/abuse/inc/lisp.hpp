...
struct lisp_function {
    union {
        lisp_sys_function sys;
        lisp_user_function user;
    };
};
...
struct lisp_value {
    union {
        lisp_number     number;
        lisp_pointer    pointer;
        lisp_character  character;
        lisp_string     string;
        lisp_object_var object_var;
    };
};
...
struct LISP_SYMBOL {
    ...
    LISP_FUNCTION *function;
    LISP_STRING *name;
    LISP_SYMBOL *left, *right;
};

struct GENERIC_CONS_CELL {
    ltype type;
    union {
        GENERIC_CONS_CELL *cdrcell;
        LISP_VALUE *cdrvalue;
        LISP_SYMBOL *cdrsymbol;
    };
    union {
        GENERIC_CONS_CELL *carcell;
        LISP_VALUE *carvalue;
        LISP_SYMBOL *carsymbol;
    };
};

//typedef GENERIC_CONS_CELL *LPGENERIC_CELL;
