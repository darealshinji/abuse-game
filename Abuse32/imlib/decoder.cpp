...
/* Static variables */
__int8 curr_size;                     /* The current code size */
__int8 clear;                         /* Value for a clear code */
__int8 ending;                        /* Value for a ending code */
__int8 newcodes;                      /* First available code */
__int8 top_slot;                      /* Highest code for current size */
__int8 slot;                          /* Last read code */

/* The following static variables are used
 * for seperating out codes
 */
__int8 navail_bytes = 0;              /* # bytes left in block */
__int8 nbits_left = 0;                /* # bits left in current byte */
 ...
 */
  ...
  unsigned __int8 prefix[MAX_CODES + 1];           /* Prefix linked list */

/* __int8 decoder(linewidth)
 *    __int8 linewidth;               * Pixels per line of image *
 *
...
__int8 decode_gif_data(image *im, FILE *fp)
{
   unsigned char *sp, *bufptr, *buf;
